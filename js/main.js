...
let meshList = [];
let velocity = 1;
const GRAVITY = 0.362; //gravity constant
...
function init()
{
   ...
   setupLevel(1)
   //animation function (effectivley main loop) needs to be called animate lowercase in three.js so I canont full caps it
